...
def escolha_carreira():  #observar
    print(f"Gerencial: {var1.get()},\nTécnica : {var2.get()}")

ttk.Label(janela, text="Escolha sua vocação:").grid(row=0, sticky=tk.W)

var1 = tk.IntVar()  #observar
ttk.Checkbutton(janela, text="Gerencial", variable=var1).grid(row=1, sticky=tk.W)  #observar

var2 = tk.IntVar()  #observar
ttk.Checkbutton(janela, text="Técnica", variable=var2).grid(row=2, sticky=tk.W)  #observar
